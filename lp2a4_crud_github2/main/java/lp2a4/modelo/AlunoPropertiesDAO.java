...
public class AlunoPropertiesDAO implements AlunoDAO {
	...
	/**
	 * A depender do sistema operacional será necessário alterar o caminho do
	 * arquivo
	 */
	private static final String CAMINHO_ARQUIVO = "D:\\Guilherme\\Documents\\IFSP - 4° Semestre\\LP2A4\\Atividades\\Crud- Properties\baseAlunos.properties";

	/**
	 * Bloco estático - Está sendo utilizado para inicilizar o objeto baseAluno com
	...
	/**
	 * Persiste no arquivo de propriedade as informações do objeto baseAluno que
	 * estão na memória.
	 * 
	 * É sincronizado para evitar que mais de um salvamento seja realizado
	 * concorrentemente, isso contudo não evitará race conditions.
	 */
